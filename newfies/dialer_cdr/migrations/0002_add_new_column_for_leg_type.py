...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoIPCall.leg_type'
        db.add_column('dialer_cdr', 'leg_type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VoIPCall.leg_type'
        db.delete_column('dialer_cdr', 'leg_type')
    ...
    models = {
        ...
        'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'HIZQT'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            ...
            'expirationdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 9, 20, 28, 37, 724674)'}),
            ...
            'startingdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 9, 20, 28, 37, 724584)'}),
        ...
        'dialer_cdr.callrequest': {
            ...
            'call_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 9, 20, 28, 37, 729679)'}),
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'05acf61a-0b09-11e1-a758-00231470a30c'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'dialer_cdr.voipcall': {
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'05ad69f6-0b09-11e1-a758-00231470a30c'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
