...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoiceApp.tts_language'
        db.add_column(u'voice_app', 'tts_language',
                      self.gf('user_profile.fields.LanguageField')(max_length=2, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'VoiceApp.tts_language'
        db.delete_column(u'voice_app', 'tts_language')
    ...
    models = {
        ...
        'voice_app.voiceapp': {
            ...
            'tts_language': ('user_profile.fields.LanguageField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
