...
APP_DIR_NEWFIES = os.path.normpath(os.path.join(os.getcwd(), '../../')) + '/newfies/'
sys.path.insert(0, APP_DIR)
sys.path.insert(1, APP_DIR_NEWFIES)
...
version = ".".join(map(str, newfies.VERSION[0:2]))
# The full version, including alpha/beta/rc tags.
release = newfies.__version__
...
latex_documents = [
  ('index', 'newfies-dialer.tex', u'Newfies-Dialer Documentation',
...
man_pages = [
    ('index', 'newfies-dialer', u'Newfies-Dialer Documentation',
     [u'Arezqui Belaid'], 1)
]
