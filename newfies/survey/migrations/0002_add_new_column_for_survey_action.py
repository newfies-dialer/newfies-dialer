...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyQuestion.type'
        db.add_column('survey_surveyquestion', 'type',
                      self.gf('django.db.models.fields.IntegerField')(default='1', max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SurveyQuestion.gateway'
        db.add_column('survey_surveyquestion', 'gateway',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dialer_gateway.Gateway'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SurveyQuestion.data'
        db.add_column('survey_surveyquestion', 'data',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyQuestion.type'
        db.delete_column('survey_surveyquestion', 'type')

        # Deleting field 'SurveyQuestion.gateway'
        db.delete_column('survey_surveyquestion', 'gateway_id')

        # Deleting field 'SurveyQuestion.data'
        db.delete_column('survey_surveyquestion', 'data')
    ...
    models = {
        ...
        'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'WFNDV'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
