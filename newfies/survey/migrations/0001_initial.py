    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('callrequest', models.ForeignKey(related_name=b'survey_callrequest', blank=True, to='dialer_cdr.Callrequest', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invalid_audiofile', models.ForeignKey(related_name=b'survey_invalid_audiofile', verbose_name='audio invalid input', blank=True, to='audiofield.AudioFile', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('audiofile', models.ForeignKey(verbose_name='audio File', blank=True, to='audiofield.AudioFile', null=True)),
                ('invalid_audiofile', models.ForeignKey(related_name=b'survey_template_invalid_audiofile', verbose_name='audio invalid input', blank=True, to='audiofield.AudioFile', null=True)),
            ],
            options={
                'ordering': ['order', 'survey'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name=b'survey_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'survey',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='date')),
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(related_name=b'survey_template_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='section',
            field=models.ForeignKey(related_name=b'ResultSum Section', to='survey.Section'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='resultaggregate',
            name='survey',
            field=models.ForeignKey(related_name=b'ResultSum Survey', to='survey.Survey'),
            preserve_default=True,
        ),
        ...
        migrations.AddField(
            model_name='result',
            name='section',
            field=models.ForeignKey(related_name=b'Result Section', to='survey.Section'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='result',
        ...
        migrations.AddField(
            ...
            name='goto',
            field=models.ForeignKey(related_name=b'Goto Template Section', blank=True, to='survey.Section_template', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='branching_template',
            name='section',
            field=models.ForeignKey(related_name=b'Branching Template Section', to='survey.Section_template'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='branching_template',
        ...
        migrations.AddField(
            ...
            name='goto',
            field=models.ForeignKey(related_name=b'Goto Section', blank=True, to='survey.Section', null=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='branching',
            name='section',
            field=models.ForeignKey(related_name=b'Branching Section', to='survey.Section'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='branching',
