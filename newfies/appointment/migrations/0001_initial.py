...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('calendar_setting', (
            ...
            ('cid_number', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('cid_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ...
        db.create_table(u'appointment_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 19, 0, 0))),
            ('end', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 19, 0, 0))),
            ...
            ('end_recurring_period', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 12, 19, 0, 0), null=True, blank=True)),
        ...
        db.create_table(u'appointment_smstemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=75)),
            ('template_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30)),
            ('sender_phonenumber', self.gf('django.db.models.fields.CharField')(max_length=75)),
            ('sms_text', self.gf('django.db.models.fields.TextField')(max_length=500)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('appointment', ['SMSTemplate'])
        ...
        db.create_table(u'appointment_alarm', (
            ...
            ('sms_template', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sms template', null=True, to=orm['appointment.SMSTemplate'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event', to=orm['appointment.Event'])),
            ('date_start_notice', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 19, 0, 0))),
            ...
            ('phonenumber_sms_cancel', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'appointment_smstemplate')
    ...
    models = {
        ...
        'appointment.calendarsetting': {
            ...
            'cid_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'cid_number': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'XJIBF'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
        ...
        u'dialer_cdr.callrequest': {
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'159445f0-5144-11e3-a7c9-00231470a30c'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
