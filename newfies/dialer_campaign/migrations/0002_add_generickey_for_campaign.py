...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campaign.voipapp'
        db.delete_column(u'dialer_campaign', 'voipapp_id')

        # Adding field 'Campaign.content_type'
        db.add_column(u'dialer_campaign', 'content_type',
        ...
        db.add_column(u'dialer_campaign', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Campaign.voipapp'
        db.add_column(u'dialer_campaign', 'voipapp',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='VoIP Application', to=orm['voip_app.VoipApp']),
                      keep_default=False)

        # Deleting field 'Campaign.content_type'
        db.delete_column(u'dialer_campaign', 'content_type_id')

        # Deleting field 'Campaign.object_id'
        db.delete_column(u'dialer_campaign', 'object_id')
    ...
    models = {
        ...
        'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'EZMPR'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            ...
            'expirationdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 25, 0, 48, 7, 128720)'}),
            ...
            'startingdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 25, 0, 48, 7, 128638)'}),
