...
class ForeignKeySearchInput(forms.HiddenInput):
    ...
    class Media:
        css = {
            'all': ('%snewfies/css/jquery.autocomplete.css' \
            % settings.STATIC_URL),
        }
        js = (
            '%snewfies/js/jquery-1.4.4.js' % settings.STATIC_URL,
            '%snewfies/js/jquery.autocomplete.js' % settings.STATIC_URL,
            '%snewfies/js/AutocompleteObjectLookups.js ' % settings.STATIC_URL,
        )
