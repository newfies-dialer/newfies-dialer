...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Alarm.phonenumber_sms_cancel'
        db.delete_column(u'appointment_alarm', 'phonenumber_sms_cancel')

        # Adding field 'Alarm.phonenumber_sms_failure'
        db.add_column(u'appointment_alarm', 'phonenumber_sms_failure',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Alarm.phonenumber_sms_cancel'
        db.add_column(u'appointment_alarm', 'phonenumber_sms_cancel',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Alarm.phonenumber_sms_failure'
        db.delete_column(u'appointment_alarm', 'phonenumber_sms_failure')
    ...
    models = {
        ...
        u'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'IVGSU'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
        ...
        u'dialer_cdr.callrequest': {
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'96b2b4b4-5793-11e3-8feb-00231470a30c'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
