...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyCampaignResult.voipcall'
        db.add_column('survey_surveycampaignresult', 'voipcall',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='VoIPCall', to=orm['dialer_cdr.VoIPCall']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyCampaignResult.voipcall'
        db.delete_column('survey_surveycampaignresult', 'voipcall_id')
    ...
    models = {
        ...
        'country_dialcode.prefix': {
            ...
            'country_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['country_dialcode.Country']", 'null': 'True', 'db_column': "'country_id'", 'blank': 'True'}),
        ...
        'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'UKPBD'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'expirationdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 16, 0, 0)'}),
            ...
            'startingdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 16, 0, 0)'}),
        ...
        'dialer_cdr.callrequest': {
            ...
            'call_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 16, 0, 0)'}),
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'3a75cdbe-cf25-11e1-8569-00231470a30c'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'dialer_cdr.voipcall': {
            ...
            'dialcode': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['country_dialcode.Prefix']", 'null': 'True', 'blank': 'True'}),
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'3a764a50-cf25-11e1-8569-00231470a30c'", 'max_length': '120', 'null': 'True', 'blank': 'True'}),
        ...
        'survey.surveycampaignresult': {
            ...
            'voipcall': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'VoIPCall'", 'to': "orm['dialer_cdr.VoIPCall']"})
        },
