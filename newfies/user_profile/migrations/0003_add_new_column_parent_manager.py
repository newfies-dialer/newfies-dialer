...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.manager'
        db.add_column('user_profile', 'manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user_profile.UserProfile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.manager'
        db.delete_column('user_profile', 'manager_id')
    ...
    models = {
        ...
        u'user_profile.userprofile': {
            ...
            'manager': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['user_profile.UserProfile']", 'null': 'True', 'blank': 'True'}),
