...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dialer_callrequest', (
            ...
            ('request_uuid', self.gf('django.db.models.fields.CharField')(default='2be2ebd8-50a7-11e3-8540-00231470a30c', max_length=120, null=True, db_index=True, blank=True)),
            ('aleg_uuid', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('call_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 19, 0, 0))),
        ...
        db.create_table('dialer_cdr', (
            ...
            ('request_uuid', self.gf('django.db.models.fields.CharField')(default='2be38c3c-50a7-11e3-8540-00231470a30c', max_length=120, null=True, blank=True)),
    ...
    models = {
        ...
        u'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'MKEFS'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
        ...
        u'dialer_cdr.callrequest': {
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'2be2ebd8-50a7-11e3-8540-00231470a30c'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        u'dialer_cdr.voipcall': {
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'2be38c3c-50a7-11e3-8540-00231470a30c'", 'max_length': '120', 'null': 'True', 'blank': 'True'}),
