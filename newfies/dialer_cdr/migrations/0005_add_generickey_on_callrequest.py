...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Callrequest.voipapp'
        db.delete_column(u'dialer_callrequest', 'voipapp_id')

        # Adding field 'Callrequest.content_type'
        db.add_column(u'dialer_callrequest', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Callrequest.object_id'
        db.add_column(u'dialer_callrequest', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Callrequest.voipapp'
        db.add_column(u'dialer_callrequest', 'voipapp',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voip_app.VoipApp'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Callrequest.content_type'
        db.delete_column(u'dialer_callrequest', 'content_type_id')

        # Deleting field 'Callrequest.object_id'
        db.delete_column(u'dialer_callrequest', 'object_id')
    ...
    models = {
        ...
        'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'LLFOQ'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            ...
            'expirationdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 25, 23, 54, 24, 270066)'}),
            ...
            'startingdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 25, 23, 54, 24, 269984)'}),
        ...
        'dialer_cdr.callrequest': {
            ...
            'call_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 25, 23, 54, 24, 274523)'}),
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'5a7279ac-2f4b-11e1-89d6-00231470a30c'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'dialer_cdr.voipcall': {
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'5a731588-2f4b-11e1-89d6-00231470a30c'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
