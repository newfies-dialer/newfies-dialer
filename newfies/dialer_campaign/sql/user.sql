...
-- http://docs.djangoproject.com/en/dev/ref/django-admin/#django-admin-sqlcustom
...
-- That could be a good place for initial data
ALTER TABLE  dialer_campaign ADD INDEX ( startingdate );
