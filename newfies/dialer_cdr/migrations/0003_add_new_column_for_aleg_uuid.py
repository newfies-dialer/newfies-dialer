...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Callrequest.aleg_uuid'
        db.add_column(u'dialer_callrequest', 'aleg_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Callrequest.aleg_uuid'
        db.delete_column(u'dialer_callrequest', 'aleg_uuid')
    ...
    models = {
        ...
        'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'KBIWU'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            ...
            'expirationdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 10, 21, 12, 46, 907953)'}),
            ...
            'startingdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 10, 21, 12, 46, 907878)'}),
        ...
        'dialer_cdr.callrequest': {
            ...
            'call_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 10, 21, 12, 46, 905934)'}),
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'5b1bf914-0bd8-11e1-9305-0026b9cc2096'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'dialer_cdr.voipcall': {
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'5b1c8be0-0bd8-11e1-9305-0026b9cc2096'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
