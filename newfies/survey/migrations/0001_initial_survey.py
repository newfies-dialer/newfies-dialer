...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'IHTVC'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
        ...
        'dialer_cdr.callrequest': {
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'ac49dada-8a36-11e2-8876-00231470a30c'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
