    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sms_gateway', models.ForeignKey(related_name=b'SMS Gateway', verbose_name='sms gateway', to='sms.Gateway', help_text='select SMS gateway')),
                ('user', models.ForeignKey(related_name=b'SMSCampaign owner', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sms_gateway', models.ForeignKey(related_name=b'smsmessage_smsgateway', blank=True, to='sms.Gateway', help_text='select SMS gateway', null=True, verbose_name='sms gateway')),
            ],
            options={
                'db_table': 'smsmessage',
