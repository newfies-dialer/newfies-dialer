...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Campaign', fields ['startingdate']
        db.create_index(u'dialer_campaign', ['startingdate'])

    def backwards(self, orm):
        # Removing index on 'Campaign', fields ['startingdate']
        db.delete_index(u'dialer_campaign', ['startingdate'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 13, 11, 35, 322246)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 13, 11, 35, 322172)'}),
        ...
        'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'FKXOP'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            ...
            'expirationdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 31, 13, 11, 35, 319911)'}),
            ...
            'startingdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 31, 13, 11, 35, 319824)', 'db_index': 'True'}),
