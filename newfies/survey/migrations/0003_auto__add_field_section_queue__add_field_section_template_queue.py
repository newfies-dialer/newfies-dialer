...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.queue'
        db.add_column(u'survey_section', 'queue',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['callcenter.Queue'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Section_template.queue'
        db.add_column(u'survey_section_template', 'queue',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['callcenter.Queue'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.queue'
        db.delete_column(u'survey_section', 'queue_id')

        # Deleting field 'Section_template.queue'
        db.delete_column(u'survey_section_template', 'queue_id')
    ...
    models = {
        ...
        u'callcenter.queue': {
            ...
            'abandoned_resume_allowed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'discard_abandoned_after': ('django.db.models.fields.IntegerField', [], {'default': '14400', 'max_length': '250', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manager': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'queue manager'", 'null': 'True', 'to': u"orm['auth.User']"}),
            'max_wait_time': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'max_wait_time_with_no_agent': ('django.db.models.fields.IntegerField', [], {'default': '120', 'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'max_wait_time_with_no_agent_time_reached': ('django.db.models.fields.IntegerField', [], {'default': '5', 'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'moh_sound': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'record_template': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'strategy': ('django.db.models.fields.IntegerField', [], {'default': '5', 'null': 'True', 'blank': 'True'}),
            'tier_rule_no_agent_no_wait': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'tier_rule_wait_multiply_level': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'tier_rule_wait_second': ('django.db.models.fields.IntegerField', [], {'default': '300', 'max_length': '250', 'null': 'True', 'blank': 'True'}),
            'tier_rules_apply': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'time_base_score': ('django.db.models.fields.CharField', [], {'default': "'queue'", 'max_length': '250'}),
            'updated_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        ...
        u'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'KLILY'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            ...
            'expirationdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 0, 0)'}),
            ...
            'startingdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 4, 0, 0)'}),
        ...
        u'dialer_cdr.callrequest': {
            ...
            'call_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 4, 0, 0)'}),
            ...
            'request_uuid': ('django.db.models.fields.CharField', [], {'default': "'bc41f72c-9d25-11e2-964f-000c2925d15f'", 'max_length': '120', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        u'survey.section': {
            ...
            'queue': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['callcenter.Queue']", 'null': 'True', 'blank': 'True'}),
