...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'voice_app', (
            ...
            ('gateway', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dialer_gateway.Gateway'], null=True, blank=True)),
            ('data', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='VoIP App owner', to=orm['auth.User'])),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('voice_app', ['VoiceApp'])

    def backwards(self, orm):
        # Deleting model 'VoiceApp'
        db.delete_table(u'voice_app')
    ...
    models = {
        ...
        'voice_app.voiceapp': {
            'Meta': {'object_name': 'VoiceApp', 'db_table': "u'voice_app'"},
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
