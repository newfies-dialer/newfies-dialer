...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Contact', fields ['phonebook', 'contact']
        db.delete_unique(u'dialer_contact', ['phonebook_id', 'contact'])

    def backwards(self, orm):
        # Adding unique constraint on 'Contact', fields ['phonebook', 'contact']
        db.create_unique(u'dialer_contact', ['phonebook_id', 'contact'])
    ...
    models = {
        ...
        'dialer_campaign.campaign': {
            ...
            'campaign_code': ('django.db.models.fields.CharField', [], {'default': "'YROTP'", 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            ...
            'expirationdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 27, 13, 23, 11, 632965)'}),
            ...
            'startingdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 27, 13, 23, 11, 632879)'}),
